...
def setup_database():
    ...
    temp_dir = tempfile.mkdtemp(prefix="vjson_concurrent_")
...
def cleanup_database(temp_dir):
    """Clean up test database - ignore errors from locked Tantivy index files"""
